...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_phones', function (Blueprint $table) {
            ...
            $table->string('model', 50); // Mẫu điện thoại (model VARCHAR(50) NOT NULL)
            ...
            $table->integer('stock_quantity')->default(0); // Số lượng hàng có sẵn (stock_quantity INT DEFAULT 0)
