...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbl_phones', function (Blueprint $table) {
            ...
            $table->integer('expandable_storage')->default(0); // Hỗ trợ thẻ nhớ ngoài (expandable_storage BOOLEAN DEFAULT FALSE)
            ...
            $table->integer('wireless_charging')->default(0); // Hỗ trợ sạc không dây (wireless_charging BOOLEAN DEFAULT FALSE)
