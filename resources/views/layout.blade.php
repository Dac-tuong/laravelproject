            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-12" style="padding-bottom: 12px;">
                <div class="product-content">
                    <form>
                        ...
                        <input type="hidden" value="${item.favorite_phone_id }"
                            class="product_id_${item.favorite_phone_id }">
                        <input type="hidden" value="${item.product_favorite.product_name}"
                            class="product_name_${item.favorite_phone_id }">
